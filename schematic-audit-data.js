...
patch('pedal:fuzz-face',{row:{
 ...
 7:'ElectroSmash-Archiv Fuzz Face Analyse; klassische Dallas-Arbiter PNP-Topologie gegengeprüft.',
...
patch('pedal:tube-screamer',{name:'TS808 · True-Bypass-Effektkern',row:{
 ...
 7:'ElectroSmash-Archiv TS808-Analyse für den Effektkern; historische Ibanez/ToneHome-Serviceunterlage separat für Original-JFET-Bypass.',
...
patch('pedal:phase90',{name:'MXR Phase 90 · Script Logo',row:{
 ...
 4:'BOM NOCH NICHT EINGEFROREN. GGG P90 Replica 2015June30 zeigt u.a. 4× 2N5952, 1× 2N4125/2N3906-Alternative, 6 OpAmp-Stufen, 22k-Werte in den Allpass-Zweigen, 500k reverse-log Rate und 250k Bias-Trimmer. Die ältere ToneForge/andere Referenz verwendete teils abweichende Werte/RefDes (z.B. 24k). Erst nach netzweitem Vergleich mit dem LTspice-CAD wird eine konkrete BOM freigegeben.',
...
patch('pedal:big-muff',{row:{
 6:'Nicht verschiedene Muff-Revisionen mischen. Die aktuelle ToneForge-BOM stimmt mit der von ElectroSmash archivierten American-Version-3-Referenz (1976–1977) überein; Kit Rae dokumentiert jedoch mehrere reale V3-Untervarianten. ToneForge bezeichnet diese Werte daher als eine konkrete V3-Referenz, nicht als universelle V3-BOM.',
 7:'ElectroSmash-Archiv American V3 (1976–1977) BOM gegengeprüft; Kit Rae Circuit Guide dient zur Variantenkontrolle.',
 8:'American V3 · ElectroSmash-Referenz 1976–1977'
}});
...
patch('pedal:rangemaster',{row:{
 ...
 7:'ElectroSmash-Archiv Dallas Rangemaster Analyse; Werte und positive-ground Topologie gegengeprüft.',
...
patch('pedal:tone-bender-mkii',{name:'Tone Bender Mark II Professional · PNP Germanium',row:{
 ...
 7:'General Guitar Gadgets Tone Bender Mark II Professional PNP-Germanium-Schematic/BOM, 2012-02-09, visuell und gegen Werte gegengeprüft.',
 8:'GGG PNP-Germanium-Replica · positive Masse'
}});

patch('pedal:green-ringer',{row:{
 4:'Q1/Q3 2N5088 oder 2N5089; Q2 2N3906 low-gain PNP; D1/D2 eng gematchtes Paar (Si, Ge oder Schottky; z.B. 1N914 möglich); R1 560k, R2 160k, R3 18k, R4 6.2k, R5/R6 10k, R7/R8 68k, R9/R10 22k, R11 10k, R12 47k, R13 1.5M; C1/C2/C3 47nF, C4 100µF, C5 100nF',
 7:'General Guitar Gadgets Green Ringer Schematic/BOM; Q1/Q3, Q2, gematchte Dioden und R/C-Werte visuell gegengeprüft.',
 8:'GGG Green Ringer Replica · 2012-01-10'
}});

patch('pedal:ea-tremolo',{row:{
 4:'Q1 2N3904; Q2/Q4 2N5457 oder J201; Q3 2N5088; R: 1M×3, 560k, 150k, 47k, 180R, 1k×3, 120k, 15k×2, 2.2M, 10k, 68k; C1 220nF, C2/C4 470nF, C3 22µF, C5/C6/C7 1µF, C8 0.05µF (50nF), C9 10µF; Volume 25k log, Depth 250k lin, Speed 100k reverse-log',
 7:'General Guitar Gadgets Improved EA Tremolo Schematic/BOM, 2007-11-13, visuell gegengeprüft. C8 ist im Plan ausdrücklich 0.05µF.',
...
patch('pedal:micro-amp',{name:'MXR Micro Amp · TL061',row:{
 ...
 7:'ElectroSmash-Archiv MXR Micro Amp Analyse; TL061-Topologie und BOM gegengeprüft.',
